...
class PendingScreen extends Component {
  ...
  onSelectComplaint(params) {
    // console.log("complaintttttt", params)
  ...
  searchKeyValueInList(list) {
    let result = "";
    result = list.filter((obj) => obj.zx_complaintstatus == "Pending");
    // console.log(result);
    return result;
  }
  ...
  getDataNode() {
    ...
    if (details && details.length) {
      ...
      // console.log("filterrpendingg",searchList)
