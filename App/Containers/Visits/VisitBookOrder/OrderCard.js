    ...
    <View style={styles.v2}>
      ...
      <View style={{ flexDirection: "row", marginTop: 10, width: wp("55%") }}>
          <View style={{ width: "100%", flex: 1 }}>
            <Text style={{ fontSize: 14, color: "#666666C4",fontWeight:"bold",right:wp("12%"),marginTop:hp("0.8%"), width:wp("15%") }}>
              Bags
            </Text>
          </View>
        ...
        <View style={{ flexDirection: "row", marginTop: 10, width: wp("35%") }}>
          <View style={{ width: "100%", flex: 1 }}>
            <Text style={{ fontSize: 14, color: "#666666C4", marginTop: 1,fontWeight:"bold" }}>
              Discount
            </Text>
          </View>
          <View style={{ width: "100%", flex: 1 }}>
        ...
        <View style={{ flexDirection: "row", marginTop: 10, width: wp("35%") }}>
          ...
          <View style={{ width: "100%", flex: 1 }}>
            ...
            >
              {unit_price ? HelperService.FixedDecimalValue(unit_price) : 0}
            </Text>
          </View>
        </View>
        <View style={{ flexDirection: "row", marginTop: 10, width: wp("35%"),marginRight:wp("45%") }}>
          <View style={{ width: "100%", flex: 1 }}>
            <Text style={{ fontSize: 14, color: "#666666C4", marginTop: 1,fontWeight:"bold" }}>
              Total QTY
            </Text>
        ...
        <View style={{ flexDirection: "row", marginTop: 10, width: wp("100%"),marginLeft:wp("20%") }}>
          <View style={{ width: "100%", flex: 1 }}>
            <Text style={{ fontSize: 14, color: "#666666C4", marginTop: 1,fontWeight:"bold" }}>
              Order Value(without discount)
            </Text>
          </View>
          <View style={{ width: "100%", flex: 1 }}>
            <Text
        ...
        <View style={{ flexDirection: "row", marginTop: 10, width: wp("100%"),marginLeft:wp("20%") }}>
          ...
          <View style={{ width: "100%", flex: 1 }}>
            ...
            >
              {value-(value*(price/100)) ? HelperService.currencyValue(HelperService.FixedDecimalValue(value-(value*(price/100)))) : 0}
            </Text>
          </View>
        </View>
      </View>
