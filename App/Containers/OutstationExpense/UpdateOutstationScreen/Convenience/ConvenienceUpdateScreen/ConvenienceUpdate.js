...
import Style from './ConvenienceUpdateStyle';
import InputText from '../../../../../Components/FormInput/InputText';


class ConvenienceUpdateScreen extends Component {
    componentDidMount() {
        this.props.updateOutstationForm(this.props.selectConvenienceExpense);
    }
    ...
    submit() {
        this.props.updateConvenienceExpense({
    ...
    render() {
        ...
        return (
            <View style={Style.container}>
                <Text style={Style.heading}>{'UPDATE CONVEYANCE'}</Text>
                <ScrollView style={Style.action}>
                    ...
                    <View style={Style.buttonContainer}>
                        <BlueButton
                            ...
                            large
                            title={'SAVE'}
                            disabled={this.props.updateConvenienceExpenseLoader}
                            loading={this.props.updateConvenienceExpenseLoader}
                            onPress={() => this.submit()}
                        />
                    </View>
...
const mapStateToProps = (state) => ({
    ...
    updateConvenienceExpenseLoader: state.outstations.updateConvenienceExpenseLoader,
    selectExpense: state.outstations.selectExpense,
    selectConvenienceExpense: state.outstations.selectConvenienceExpense,
...
const mapDispatchToProps = (dispatch) => ({
    ...
    updateConvenienceExpense: (params) => dispatch(OutstationActions.updateConvenienceExpense(params))
});
