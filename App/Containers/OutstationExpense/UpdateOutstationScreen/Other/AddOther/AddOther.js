...
import Style from './AddOtherStyle';
...
class AddOtherScreen extends Component {
    ...
    async componentDidMount() {
        ...
        this.props.changeOutstationForm({ edited_field: 'outstation_type__c', edited_value: 'Other Expenses' });
...
const mapStateToProps = (state) => ({
    ...
    addOtherExpenseLoader: state.outstations.addOtherExpenseLoader,
...
const mapDispatchToProps = (dispatch) => ({
    ...
    addOtherExpense: (params) => dispatch(OutstationActions.addOtherExpense(params))
});
