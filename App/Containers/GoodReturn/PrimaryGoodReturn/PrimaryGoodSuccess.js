...
class PrimaryGoodSuccess extends Component {
  render() {
      ...
      <View>
        ...
        <View style={{ alignItems: "center", top: hp("20%") }}>
          ...
          <Text style={{ fontSize: 22, padding: 10, textAlign: "center" }}>
            Good Return Id is {data.primaryGoodReturnForm.data.goodsreturnHeader.zx_recordid}
          </Text>
        </View>
        <TouchableOpacity
          style={{
...
const mapStateToProps = (state) => ({
  data: state.orders.primaryGoodReturnForm,
});
