...
import PrimaryShippingDetail from "./PrimaryShippingDetail";
import OrdersActions from "App/Stores/Orders/Actions";
import { connect } from "react-redux";

function ShippingGood(props) {
    ...
    <View style={{marginTop:hp("5%")}}>
      ...
      <Modal isVisible={isModalVisible}>
        <View style={{ flex: 1, backgroundColor: "white" }}>
          ...
          <PrimaryShippingDetail setModalVisible={()=>setModalVisible(false)}/>
        </View>
      </Modal>
    </View>
  );
...
export default connect(mapStateToProps, mapDispatchToProps) (ShippingGood);
