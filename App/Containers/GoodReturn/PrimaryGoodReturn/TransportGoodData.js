...
class TransportGoodData extends Component {
  constructor(props) {
    super(props);
    this.state = {
      timer: null,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getTransport: (params) => dispatch(OrdersActions.getTransport(params)),
  changeBrandSearchFilters: (params) =>
    dispatch(OrdersActions.changeBrandSearchFilters(params)),
});
export default connect(mapStateToProps, mapDispatchToProps)(TransportGoodData);
