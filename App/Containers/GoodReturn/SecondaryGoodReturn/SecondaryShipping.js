...
import SecondaryShippingDetail from "./SecondaryShippingDetail";
import OrdersActions from "App/Stores/Orders/Actions";
import { connect } from "react-redux";

function SecondaryShipping(props) {
    ...
    <View style={{marginTop:hp("5%")}}>
          ...
          <View>
            ...
            <View style={{flexDirection:"column",borderColor:Colors.lightGrey,borderBottomWidth:1,width:wp("40%"),margin:"4%"}}>
              ...
              <TextInput
                ...
                value={props.shipDetail.zx_recordid}
                editable={false}
              />
            </View>
            <View style={{flexDirection:"column",borderColor:Colors.lightGrey,borderBottomWidth:1,width:wp("40%"),margin:"4%"}}>
              ...
              <TextInput
                style={{ height: 40 }}
                placeholder="Enter here!"
                value={props.shipDetail.zx_contactperson}
                editable={false}
              />
            </View>
            <View style={{flexDirection:"column",borderColor:Colors.lightGrey,borderBottomWidth:1,width:wp("40%"),margin:"4%"}}>
              ...
              <TextInput
                style={{ height: 40 }}
                placeholder="Enter here!"
                value={props.shipDetail.zx_city11}
                editable={false}
              />
            </View>
            ...
            <View style={{flexDirection:"column",borderColor:Colors.lightGrey,borderBottomWidth:1,width:wp("40%"),margin:"4%"}}>
              ...
              <TextInput
                style={{ height: 40 }}
                placeholder="Enter here!"
                value={props.shipDetail.zx_contact}
                editable={false}
              />
            </View>
            <View style={{flexDirection:"column",borderColor:Colors.lightGrey,borderBottomWidth:1,width:wp("88.1%"),margin:"4%"}}>
                <Text style={{fontWeight:"bold",fontSize:14}}>Shipping Address</Text>
              <TextInput
                style={{ height: 40, width:wp("100%") }}
                placeholder="Enter here!"
                value={props.shipDetail.zx_address}
                editable={false}
              />
            </View>
            </View>
      ...
      <Modal isVisible={isModalVisible}>
        <View style={{ flex: 1, backgroundColor: "white" }}>
          ...
          <SecondaryShippingDetail setModalVisible={()=>setModalVisible(false)}/>
        </View>
      </Modal>
    </View>
  );
...
export default connect(mapStateToProps, mapDispatchToProps) (SecondaryShipping);
