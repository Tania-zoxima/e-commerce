...
class ProjectSuccess extends Component {
  fetchCall() {
      ...
      <View>
        ...
        <View style={{ alignItems: "center", top: hp("20%") }}>
          ...
          >
            ...
            Project Id {data.recordid[0].zx_recordid} Created Successfully!
          </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectSuccess);
