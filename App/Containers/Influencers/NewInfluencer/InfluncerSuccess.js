...
class InfluncerSuccess extends Component {
  render() {
      ...
      <View>
        ...
        <View style={{ alignItems: "center", top: hp("20%") }}>
          ...
          >
            ...
            Influencer {data.recordId} Created Successfully!
          </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(InfluncerSuccess);
