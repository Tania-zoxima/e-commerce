...
class GoodsLayout extends React.Component {
  constructor(props) {
    super(props);
      ...
      <SafeAreaView>
        <View style={{ paddingTop: hp("1%"), paddingBottom: hp("1%") }}>
          <BackArrowButton
            ...
            onPress={() => {
              NavigationService.navigate("PlaceSecondaryGoodReturn");
            }}
            show={true}
          />
        </View>
        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              onPress={() => {
                NavigationService.navigate("SecondaryOrderDetail");
...
export default connect(mapStateToProps, mapDispatchToProps)(GoodsLayout);
