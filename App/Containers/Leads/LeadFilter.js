...
class LeadFilter extends Component {
  ...
  getSelectedFruits() {
    ...
    this.props.changeLeadSearchFilters({
      edited_field: "type",
      ...
      <View>
        ...
        >
          <BlueButton
            ...
            title={"Apply filter"}
            onPress={() => {
              this.props.getLead({ form: forms, token });
              NavigationService.navigate("Leads");
            }}
            // onPress={() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(LeadFilter);
