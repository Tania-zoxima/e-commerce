...
import Style from "./CustomerScreenStyles";
...
class CustomerScreenTabs extends React.Component {
  render() {
    ...
    return (
      ...
      >
        <Tab
          ...
          heading={
            <TabHeading style={{...Style.tabHeading, flexDirection:'column'}}>
              <Text style={Style.tabText}>Primary</Text>
              <Text style={Style.tabText}>Distributor</Text>
        ...
        <Tab
          ...
          heading={
            <TabHeading style={{...Style.tabHeading, flexDirection:'column'}}>
              <Text style={Style.tabText}>Super</Text>
              <Text style={Style.tabText}>Distributor</Text>
        ...
        <Tab
          ...
          heading={
            <TabHeading style={Style.tabHeading}>
              <Text style={Style.tabText}>Wholesaler</Text>
            </TabHeading>
          }
        />
        <Tab
          ...
          heading={
            <TabHeading style={Style.tabHeading}>
              <Text style={Style.tabText}>Retailer</Text>
            </TabHeading>
          }
        />
        <Tab
          ...
          heading={
            <TabHeading style={Style.tabHeading}>
              <Text style={Style.tabText}>Influencer</Text>
            </TabHeading>
          }
        />
      </Tabs>
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerScreenTabs);
