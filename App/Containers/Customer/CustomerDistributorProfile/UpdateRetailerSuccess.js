...
class UpdateRetailerSuccess extends Component {
  render() {
      ...
      <View>
        ...
        <View style={{ alignItems: "center", top: hp("20%") }}>
          ...
          >
            ...
            Retailer {data.recordId} Updated Successfully!
          </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateRetailerSuccess);
